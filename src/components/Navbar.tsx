    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-black/75 backdrop-blur-md border-b border-white/5 px-4 md:px-8">
      <div className="max-w-7xl mx-auto h-16 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-2 group">
          <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-teal-500 to-emerald-500 p-[1px] transition-transform group-hover:rotate-6">
            <div className="h-full w-full bg-zinc-950 rounded-lg flex items-center justify-center text-teal-400">
              <Heart className="h-4.5 w-4.5 fill-current" />
            </div>
          </div>
          <span className="text-xl font-display font-medium tracking-tight text-white group-hover:text-teal-400 transition-colors">
            Vouchly
          </span>
        </a>
        ...
        <nav className="hidden md:flex items-center gap-6 text-xs font-mono font-medium tracking-wider text-zinc-400">
          <a href="#problem-insights" className="hover:text-white transition-colors uppercase">Why Vouchly</a>
          ...
          <a href="#ai-showcase" className="hover:text-white transition-colors uppercase animate-pulse text-emerald-400">AI Showcase</a>
